...
&nbsp;<input name="back" type="button" value="<< Back" onClick="location.href='studview.php'"/>
</td>
</tr>
</table>
</fieldset>
...
//	$tbl_name="";		//your table name
	...
	*/
	...
	if($total_pages==0)
	{
		echo "<script>alert('No students in the selected Category');location.href='viewbycategory.php';</script>";
	}
	/* Setup vars for query. */
	$targetpage = "viewbycategory.php"; 	//your file name  (the name of this file)
	...
	/* Get data. */
	$sql = "SELECT * FROM studdetails WHERE category='$category' LIMIT $start, $limit";
...
echo "<tr><td></td><td></td><td>Admission No</td><td>First Name</td><td>Last Name</td><td>Class</td><td>Division</td><td>Category</td></tr>";
...
<input name="back" type="button" value="<< Back" onClick="location.href='viewbycategory.php'" style="float:right"/>
</fieldset>
