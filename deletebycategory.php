...
<tr>
<td></td>
<td align="left"><input type="submit" name="submit" value="View" style="background-color:inherit; color:inherit;"/>&nbsp;<input name="back" type="button" value="<< Back" onClick="location.href='deleteview.php'" /></td>
</tr>
</table>
</fieldset>
<?php
...
?>
<fieldset style="width:50%; margin-left:auto; margin-right:auto;">
<legend><?php echo $category; ?> details</legend>
...
//	$tbl_name="";		//your table name
	...
	*/
	...
	if($total_pages==0)
	{
		echo "<script>alert('No students in the selected Category');location.href='deletebycategory.php';</script>";
	}
	/* Setup vars for query. */
	$targetpage = "deletebycategory.php"; 	//your file name  (the name of this file)
...
<input name="back" type="button" value="<< Back" onClick="location.href='deletebycategory.php'" style="float:right"/>
</fieldset>
