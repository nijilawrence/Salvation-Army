...
$result=mysql_query("SELECT * FROM thirdhs WHERE admno='$adm'")  or die(mysql_error());
...
echo "<tr><td width=50%></td><td width=50%><a href='thirdhsedit.php?ad=".$adm."' style='text-decoration:none; color:inherit;'><input type='button' value='Edit' name='edit' style='background-color:inherit; color:inherit;'  /></a>&nbsp;<input type='button' value='Print' onClick=window.open('printthirdhs.php?ad=".$adm."') />&nbsp;<input type='button' value='<<Back' onClick='history.go(-1)'/></td></tr>";
echo "</table>";
?>
</fieldset>
</form>
