...
&nbsp;<input name="back" type="button" value="<< Back" onClick="location.href='markview.php'"/>
</td>
</tr>
</table>
</fieldset>
...
?>
<fieldset style="width:50%; margin-left:auto; margin-right:auto;">
<legend><?php echo $classname." ".strtoupper($division); ?> class mark details</legend>
...
//	$tbl_name="";		//your table name
	...
	*/
	...
	if($total_pages==0)
	{
		echo "<script>alert('Class not found');location.href='markbyclass.php';</script>";
	}
	/* Setup vars for query. */
	$targetpage = "markbyclass.php"; 	//your file name  (the name of this file)
...
<input name="back" type="button" value="<< Back" onClick="location.href='markbyclass.php'" style="float:right"/>
</fieldset>
