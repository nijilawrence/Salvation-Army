...
echo "<tr><td width=50%></td><td width=50%><a href='firsthsedit.php?ad=".$adm."' style='text-decoration:none; color:inherit;'><input type='button' value='Edit' name='edit' style='background-color:inherit; color:inherit;'  /></a>&nbsp;<input type='button' value='Print' onClick=window.open('printfirsths.php?ad=".$adm."') />&nbsp;<input type='button' value='<<Back' onClick='history.go(-1)'/></td></tr>";
echo "</table>";
?>
</fieldset>
</form>
