...
//	$tbl_name="";		//your table name
	...
	*/
	...
	$targetpage = "printbyname.php"; 	//your file name  (the name of this file)
...
echo "<td align='center'><input type='button' value='Print' name='print' style='background-color:inherit; color:inherit;' onClick=window.open('printonestudent.php?ad=".$row->admno."') /></td>";
echo '</tr>';
}
echo '</table>';
?>
