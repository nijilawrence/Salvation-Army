...
$result=mysql_query("SELECT * FROM secondhs WHERE admno='$adm'")  or die(mysql_error());
...
echo "<tr><td width=50%>Malayalam 1 : </td><td width=50%><label>".$row['malayalam1']."</label><label>".$row['malayalam1g']."</label></td></tr>";
echo "<tr><td width=50%>Malayalam 2 : </td><td width=50%><label>".$row['malayalam2']."</label><label>".$row['malayalam2g']."</label></td></tr>";
...
echo "<tr><td width=50%>Physics : </td><td width=50%><label>".$row['physics']."</label><label>".$row['physicsg']."</label></td></tr>";
echo "<tr><td width=50%>Chemistry : </td><td width=50%><label>".$row['chemistry']."</label><label>".$row['chemistryg']."</label></td></tr>";
echo "<tr><td width=50%>Biology : </td><td width=50%><label>".$row['biology']."</label><label>".$row['biologyg']."</label></td></tr>";
...
echo "<tr><td width=50%>Information Technology :</td><td width=50%><label>".$row['informationtechnology']."</label><label>".$row['informationtechnologyg']."</label></td></tr>";
$total=$row['malayalam1']+$row['malayalam2']+$row['sanskrit']+$row['english']+$row['hindi']+$row['physics']+$row['physics']+$row['biology']+$row['socialscience']+$row['maths']+$row['informationtechnology'];
...
echo "<tr><td width=50%></td><td width=50%><a href='secondhsedit.php?ad=".$adm."' style='text-decoration:none; color:inherit;'><input type='button' value='Edit' name='edit' style='background-color:inherit; color:inherit;'  /></a>&nbsp;<input type='button' value='Print' onClick=window.open('printsecondhs.php?ad=".$adm."') />&nbsp;<input type='button' value='<<Back' onClick='history.go(-1)'/></td></tr>";
echo "</table>";
?>
</fieldset>
</form>
