...
<legend>All student's mark details</legend>
...
//	$tbl_name="";		//your table name
	...
	*/
	...
	$targetpage = "markall.php"; 	//your file name  (the name of this file)
...
<input name="back" type="button" value="<< Back" onClick="location.href='markview.php'" style="float:right"/>
