...
<legend>All student's details</legend>
...
//	$tbl_name="";		//your table name
	...
	*/
	$query = "SELECT COUNT(*) as num FROM leftwithtc";
	$total_pages = mysql_fetch_array(mysql_query($query));
	$total_pages = $total_pages[num];
	if($total_pages==0)
	{
		echo "<script>alert('No records found');location.href='studview.php';</script>";
	}
	/* Setup vars for query. */
	$targetpage = "tcall.php"; 	//your file name  (the name of this file)
	...
	/* Get data. */
	$sql = "SELECT * FROM leftwithtc LIMIT $start, $limit";
...
echo "<tr><td></td><td>Admission No</td><td>First Name</td><td>Last Name</td><td>Class</td><td>Division</td><td>Date of Leaving</td></tr>";
while($row = mysql_fetch_object($result))
{
echo '<tr>';
echo "<td><a href=viewtc.php?id=".$row->id." style='text-decoration:none; color:inherit;'><input type='button' value='View' name='view' style='background-color:inherit; color:inherit;'/></a></td>";
...
<input name="back" type="button" value="<< Back" onClick="location.href='leftwithtcview.php'" style="float:right"/>
<input name="print" type="button" value="Print all" onClick="location.href='printalltc.php'" style="float:right"/>
</fieldset>
</form>
