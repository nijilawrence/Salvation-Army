...
echo "<tr><td width=50%></td><td width=50%><a href='firstupedit.php?ad=".$adm."' style='text-decoration:none; color:inherit;'><input type='button' value='Edit' name='edit' style='background-color:inherit; color:inherit;'  /></a>&nbsp;<input type='button' value='Print' onClick=window.open('printfirstup.php?ad=".$adm."') />&nbsp;<input type='button' value='<<Back' onClick='history.go(-1)'/></td></tr>";
echo "</table>";
?>
</fieldset>
</form>
