...
//	$tbl_name="";		//your table name
	...
	*/
	...
	$targetpage = "viewbyname.php"; 	//your file name  (the name of this file)
...
<input name="back" type="button" value="<< Back" onClick="location.href='viewbyname.php'" style="float:right"/>
</fieldset>
