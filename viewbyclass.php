...
{
	$classname=intval($_POST['classname']);
	$division=$_POST['division'];
	(!$_SESSION['classname'])? $_SESSION['classname']=$classname : $classname=$_SESSION['classname'];
	(!$_SESSION['division'])? $_SESSION['division']=$division : $division=$_SESSION['division'];
?>
<fieldset style="width:50%; margin-left:auto; margin-right:auto;">
<legend><?php echo $classname." ".strtoupper($division); ?> class details</legend>
...
//	$tbl_name="";		//your table name
	...
	*/
	...
	if($total_pages==0)
	{
		echo "<script>alert('No students in the entered Class');location.href='viewbyclass.php';</script>";
	}
	/* Setup vars for query. */
	$targetpage = "viewbyclass.php"; 	//your file name  (the name of this file)
...
<input name="back" type="button" value="<< Back" onClick="location.href='viewbyclass.php'" style="float:right"/>
</fieldset>
