...
if(isset($_POST['submit']))
{
	...
	mysql_query("UPDATE thirdhs SET malayalam1='$malayalam1',malayalam2='$malayalam2',sanskrit='$sanskrit',english='$english',hindi='$hindi',physics='$physics',chemistry='$chemistry',biology='$biology',socialscience='$socialscience',maths='$maths',informationtechnology='$informationtechnology' WHERE admno='$adm'")  or die(mysql_error());
	
	echo "<script>location.href='thirdhs.php?ad=$adm'</script>";
}
?>
</fieldset>
</form>
