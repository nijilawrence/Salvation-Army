...
//	$tbl_name="";		//your table name
	...
	*/
	...
	if($total_pages==0)
	{
		echo "<script>alert('No records found');location.href='deleteview.php';</script>";
	}
	/* Setup vars for query. */
	$targetpage = "deleteall.php"; 	//your file name  (the name of this file)
...
<input name="back" type="button" value="<< Back" onClick="location.href='deleteview.php'" style="float:right"/>
