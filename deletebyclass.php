...
//	$tbl_name="";		//your table name
	...
	*/
	...
	if($total_pages==0)
	{
		echo "<script>alert('Class not found');location.href='deletebyclass.php';</script>";
	}
	/* Setup vars for query. */
	$targetpage = "deletebyclass.php"; 	//your file name  (the name of this file)
...
<input name="back" type="button" value="<< Back" onClick="location.href='deletebyclass.php'" style="float:right"/>
</fieldset>
