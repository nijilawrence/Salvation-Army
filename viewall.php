...
//	$tbl_name="";		//your table name
	...
	*/
	$query = "SELECT COUNT(*) as num FROM studdetails";
	...
	$targetpage = "viewall.php"; 	//your file name  (the name of this file)
	...
	/* Get data. */
	$sql = "SELECT * FROM studdetails LIMIT $start, $limit";
...
<input name="back" type="button" value="<< Back" onClick="location.href='studview.php'" style="float:right"/>
</fieldset>
</form>
