...
echo "<tr><td width=50%>Date of Leaving :</td><td width=50%>".$row['date']."&nbsp;&nbsp;(yyyy-mm-dd)</td></tr>";
echo "<tr><td width=50%></td><td width=50%><input type='button' value='Print' onClick=window.open('printtc.php?id=".$id."') />&nbsp;<input type='button' value='<<Back' onClick='history.go(-1)'/></td></tr>";
echo "</table>";
?>
</fieldset>
</form>
